...
if ( isset($_POST['password']) && !empty($_POST['password']) ) {
	...
	$sql_registered = "SELECT user_id as user FROM users WHERE username='" . $username . "';";
    ...
    $sql = "UPDATE users SET password='" . $password . "' WHERE user_id=" . $personId . ";";    
...
<html>
    ...
    <ul class="nav-bar">
        ...
        <div class="container">
            <div class="row">
                <h1 class="col-12 mt-4 mb-4">Update Password</h1>
            </div> 
        </div>
        ...
        <div class="container">
            <form action="updatePassword.php" method="POST" id="form">
                ...
                <div class="form-group row">
                    <label for="password-id" class="col-sm-3 col-form-label text-sm-right">New Password:</label>
                    <div class="col-sm-9">
